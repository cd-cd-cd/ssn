...
class Model(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.text_token_selection_mask = nn.Sequential(nn.Linear(self.width * 3, self.width), nn.ReLU(), nn.Linear(self.width, 1), nn.Sigmoid())
        self.image_token_selection_mask = nn.Sequential(nn.Linear(self.width * 3, self.width), nn.ReLU(), nn.Linear(self.width, 1), nn.Sigmoid())
